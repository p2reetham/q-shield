...
import {
  ShieldHalf, FileSignature, Radar, Atom, Link2, ListTree, BellRing, KeyRound, Lock,
} from "lucide-react";
      ...
      <div className="px-5 py-5 border-b border-graphite-700">
        <div className="flex items-center gap-2">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
            <path d="M13 1.5L23.5 6.5V13.5C23.5 19.5 19 24 13 24.5C7 24 2.5 19.5 2.5 13.5V6.5L13 1.5Z"
              stroke="#4dd8ce" strokeWidth="1.4" />
            <path d="M13 6L18.5 8.6V13.2C18.5 16.6 16.1 19.4 13 19.9C9.9 19.4 7.5 16.6 7.5 13.2V8.6L13 6Z"
              fill="#e8a33d" fillOpacity="0.18" stroke="#e8a33d" strokeWidth="1.1" />
            <circle cx="13" cy="13" r="1.6" fill="#4dd8ce" />
          </svg>
          <div>
            <div className="font-display font-semibold tracking-wide text-[15px] leading-none">Q-SHIELD</div>
            <div className="data-label mt-1 leading-none">Threat Intelligence</div>
          </div>
        </div>
      </div>
